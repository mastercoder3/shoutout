...
const routes: Routes = [
  ...
  // { path: 'company-influenceur', loadChildren: './pages/company-influenceur/company-influenceur.module#CompanyInfluenceurPageModule' },
  { path: 'company-resultats', loadChildren: './pages/company-pages/company-resultats/company-resultats.module#CompanyResultatsPageModule' },
  { path: 'generateur-contract', loadChildren: './pages/generateur-contract/generateur-contract.module#GenerateurContractPageModule' },
  // { path: 'influeneur-resaltats', loadChildren: './pages/influeneur-resaltats/influeneur-resaltats.module#InflueneurResaltatsPageModule' },
  // { path: 'influencer', loadChildren: './pages/influencer/influencer.module#InfluencerPageModule' },
  { path: 'influencer-connect', loadChildren: './pages/influencer-pages/influencer-connect/influencer-connect.module#InfluencerConnectPageModule' },
  ...
  { path: 'inscription-company', loadChildren: './pages/company-pages/inscription-company/inscription-company.module#InscriptionCompanyPageModule' },
  { path: 'inscription', loadChildren: './pages/influencer-pages/inscription/inscription.module#InscriptionPageModule' },
